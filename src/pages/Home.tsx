...
import { Heart, Brain, Sparkles, Compass, Sun, Leaf } from "lucide-react";
  ...
  <div>
    ...
    <section className="min-h-[90vh] flex items-center justify-center px-6">
      <div className="text-center max-w-3xl mx-auto">
        ...
        >
          Terapias energéticas y formación holística para tu bienestar integral
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
    ...
    <section className="py-24 px-6">
      <div className="container mx-auto max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-heading text-3xl md:text-4xl font-light mb-6 text-foreground">¿Qué es el Reiki?</h2>
            <p className="text-muted-foreground font-body font-light leading-relaxed text-lg">
              El Reiki es una técnica de canalización de energía universal que promueve la relajación profunda
              y activa los procesos naturales de sanación del cuerpo. No es una creencia ni una religión —
              es una herramienta práctica para mejorar tu bienestar físico, emocional y mental. A través de
              la imposición de manos, se trabaja con el campo energético para restaurar el equilibrio y la armonía.
            </p>
          </div>
          <motion.img
            src={energiaManosImg}
    ...
    <section className="py-24 px-6 bg-muted/50">
      <div className="container mx-auto max-w-5xl">
        <h2 className="font-heading text-3xl md:text-4xl font-light text-center mb-16">Beneficios del Reiki</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((b, i) => (
            ...
            >
              <b.icon className="w-8 h-8 text-lavender-deep mb-4" />
    ...
    <section className="py-24 px-6">
      <div className="container mx-auto max-w-4xl">
        <h2 className="font-heading text-3xl md:text-4xl font-light text-center mb-16">Tu camino de transformación</h2>
    ...
    <section className="py-24 px-6">
      <div className="container mx-auto max-w-2xl text-center">
        <h2 className="font-heading text-3xl md:text-4xl font-light mb-6">¿Lista para comenzar?</h2>
        <p className="text-muted-foreground font-body font-light mb-8">
          Reserva tu primera sesión y comienza tu camino hacia el bienestar
        </p>
        <a
